    ...
    <section className="page-shell grid gap-10 py-14 md:grid-cols-[minmax(0,1fr)_320px] md:items-end md:py-24">
      <FadeIn className="space-y-7">
        ...
        <div className="flex flex-wrap gap-4">
          <Link
            href="/projects"
            className="rounded-full bg-[var(--color-fg)] px-6 py-3 text-sm font-medium text-white transition hover:translate-y-[-1px] hover:bg-neutral-800"
          >
          ...
          <Link
            ...
            target="_blank"
            rel="noreferrer"
            className="rounded-full border border-[var(--color-line)] px-6 py-3 text-sm font-medium text-[var(--color-fg)] transition hover:bg-white/70"
          >
            Open resume
          </Link>
        </div>
      ...
      <FadeIn delay={0.1}>
        <div className="glass-panel relative overflow-hidden rounded-[2.2rem] p-5">
          ...
          <div className="relative flex flex-col gap-5">
            <div className="flex items-center justify-between text-xs uppercase tracking-[0.24em] text-[var(--color-muted)]">
